  ...
  render: function() {
    ...
    return (
      React.DOM.div({onClick: this.onClick}, 
        React.DOM.span({className: "starts"}, model.get('starts').format('MMMM DD, mm:ss a')), 
        React.DOM.span(null, " : "), 
        React.DOM.span(null, model.get('title'))
      )
    );
  }
});
...
var AllEventsView = React.createClass({displayName: 'AllEventsView',
...
var CategoryView = React.createClass({displayName: 'CategoryView',
  onClick: function() {
    // dcategoryebugger;
  ...
  render: function() {
    return (
      React.DOM.div({className: "category-view", onClick: this.onClick}, this.props.name)
    );
  }
});

var CategoryListView = React.createClass({displayName: 'CategoryListView',
  ...
  //   }
  //   debugger;
  //   this.props.calendar.set('category', item);
  // },

  render: function() {
    return (
      React.DOM.div({className: "category-view-list"}, this.props.categories.map(this.createCategory))
    );
  }
});
