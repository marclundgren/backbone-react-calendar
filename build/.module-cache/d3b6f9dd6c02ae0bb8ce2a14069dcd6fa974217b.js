...
app.CalendarSources = React.createClass({displayName: 'CalendarSources',
  ...
  onChange: function(e) {
    ...
    // this.props.eventscollection.reset(flatFilteredEvents); // trigger a forceUpdate for everyone
    this.props.eventscollection.reset(new Backbone.GoogleEvents(flatFilteredEvents)); // trigger a forceUpdate for everyone
